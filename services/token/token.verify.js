...
// For verifying refresh token
TokenVerifier.prototype.refresh = function refresh() {
    try {
        const decoded = this.verify(REFRESH_TOKEN_KEY, this.token);

        this.refreshDecoded = decoded;
